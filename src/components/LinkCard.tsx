...
import { WhatsAppIcon, OfficialWhatsAppIcon, GoogleIcon, PixIcon, GoogleMapsIcon } from './Icons';
...
export const LinkCard: React.FC<LinkCardProps> = ({
  ...
  const renderIcon = () => {
    switch (iconType) {
      ...
      case 'instagram':
        return (
          <div className="w-12 h-12 bg-black rounded-xl flex items-center justify-center flex-shrink-0 shadow-md group-hover:scale-105 transition-transform duration-300 p-[3px]">
            <div className="w-full h-full bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] rounded-[9px] flex items-center justify-center text-white">
      ...
      case 'google':
        return (
          <div className="w-12 h-12 bg-black rounded-xl flex items-center justify-center flex-shrink-0 shadow-md group-hover:scale-105 transition-transform duration-300 p-2.5">
      ...
      case 'location':
        return (
          <div className="w-12 h-12 bg-black rounded-xl flex items-center justify-center flex-shrink-0 shadow-md group-hover:scale-105 transition-transform duration-300 p-2.5">
            <GoogleMapsIcon className="w-full h-full" />
          </div>
        );
      case 'vcard':
        return (
